...
class AppStyle{
  ...
  static  TextStyle bold24White = GoogleFonts.inter(
      color: AppColors.whiteColor,fontSize: 24,fontWeight: FontWeight.bold);
  ...
  static  TextStyle medium12Gray = GoogleFonts.inter(
      color: AppColors.greyColor,fontSize: 12,fontWeight: FontWeight.w500);
  ...
  static  TextStyle medium24White = GoogleFonts.inter(
      color: AppColors.whiteColor,fontSize: 24,fontWeight: FontWeight.w500);
